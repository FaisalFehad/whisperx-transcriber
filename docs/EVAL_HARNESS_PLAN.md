...
| Source | URL | Type |
|--------|-----|------|
| Clean session 1 | youtube.com/watch?v=M7K87rGoGps | 2+ speakers, studio |
| Clean session 2 | youtube.com/watch?v=bc6uFV9CJGg | Different speakers/accent |
...
Base file: Session 1 (15 min) + Session 2 (15 min) stitched = 30 min.
...
| Verify subtitles | Check both recordings have YouTube subtitles | Ground truth for WER |
...
- Per-session accuracy available by splitting at 15-minute mark in the results
